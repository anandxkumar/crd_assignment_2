...
import (
	...
	runcomv1alpha1 "github.com/anandxkumar/crd_assignment_2/pkg/apis/run.com/v1alpha1"
	versioned "github.com/anandxkumar/crd_assignment_2/pkg/client/clientset/versioned"
	internalinterfaces "github.com/anandxkumar/crd_assignment_2/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/anandxkumar/crd_assignment_2/pkg/client/listers/run.com/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RunV1alpha1().PipelineRuns(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RunV1alpha1().PipelineRuns(namespace).Watch(context.TODO(), options)
			},
		},
		&runcomv1alpha1.PipelineRun{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *pipelineRunInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&runcomv1alpha1.PipelineRun{}, f.defaultInformer)
}
