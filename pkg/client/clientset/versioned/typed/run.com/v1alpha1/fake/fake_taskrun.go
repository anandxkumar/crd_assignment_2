...
var taskrunsResource = schema.GroupVersionResource{Group: "run.com", Version: "v1alpha1", Resource: "taskruns"}

var taskrunsKind = schema.GroupVersionKind{Group: "run.com", Version: "v1alpha1", Kind: "TaskRun"}
